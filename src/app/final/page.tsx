...
function FinalPageContent() {
  ...
  return (
          ...
          <div>
            ...
            <p>Sharing with others is vulnerable, it also can sometimes be easier to be encouraged by the voice of others than your own voice.</p>
            <p>Once they send you the voice note, you should save it so you can replay it whenever you need a reminder.</p>
            <hr className="my-8"/>
            <p>Use this QR code to open up the following message on your phone and send to a trusted person in your life who can support you:</p>
